            ...
            <div class="row clearfix">
                <div class="col-md-12 column">
                    <table class="table table-bordered table-hover table-condensed">
                        ...
                        <#list prodPage.content as productInfo>
                            <tr>
                            ...
                            <td>
                            <#if productInfo.getProdStateEnum().msg == "上架">
                ...
                <div class="col-md-12 column">
                    <ul class="pagination pull-right">
                        ...
                        <#list 1..prodPage.totalPages as index>
                        ...
                        <#if currentPage gte prodPage.getTotalPages()>
