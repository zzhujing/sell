                ...
                <div class="col-md-12 column">
                    <table class="table table-bordered table-hover table-condensed">
                        ...
                        <#list orderPage.content as orderDTO>
                            ...
                            <td>${orderDTO.createTime?string("yyyy-MM-ss HH:mm:ss")}</td>
...
<#--弹窗-->
<div class="modal fade" id="alterModel" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<script>
    ...
    if ('WebSocket' in window) {
        webSocket = new WebSocket('ws://sell-hujing.natapp1.cc/sell/webSocket');
    }else{
        alert('该浏览器不支持weSocket！')
    }
